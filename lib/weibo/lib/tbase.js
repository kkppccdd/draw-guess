...
function TBase() {
  this.config = {
    ...
    friendship_follower:  '/friendships/followers',
...
TBase.prototype.friendship_follower=function(user,data,callback){
	var params = {
		type : 'GET',
		playload : 'friendship',
		user : user,
		data : data,
		request_method : 'friendship_follower'
	};
	var url = this.config.friendship_follower;
	console.log(url);
	this.send_request(url, params, callback);
	return this;
